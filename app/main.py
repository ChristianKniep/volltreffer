...
def _leaderboard(conn, me_id, view="both"):
    ...
    # (teamtip's points_total is authoritative even when our own recompute is
    # lower because some of a member's tips failed to import — see the progress
    # graph, which scores only the tips we hold and can therefore under-count.)
